...
<footer id="footer">
    ...
    <hr><br>
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-4">
                    <p class="text-capitalize text-center"><a href="index.php" style="color: rgb(0,0,0);">Home</a></p>
                    <p class="text-capitalize text-center"><a href="destinations.php" style="color: rgb(0,0,0);">Destinations</a></p>
                    <p class="text-capitalize text-center"><a href="newsletter.php" style="color: rgb(0,0,0);">Newsletter</a></p>
                </div>
                <div class="col-md-4">
                    <p class="text-capitalize text-center"><a href="hotelsrestaurants.php" style="color: rgb(0,0,0);">Hotels &amp; Restaurants</a></p>
                    <p class="text-capitalize text-center"><a href="gallery.php" style="color: rgb(0,0,0);">Gallery</a></p>
                    <p class="text-capitalize text-center"><a href="reviews.php" style="color: rgb(0,0,0);">Reviews</a></p>
                    <p class="text-capitalize text-center"><a href="blog.php" style="color: rgb(0,0,0);">Blog</a></p>
                </div>
                <div class="col-md-4">
                    <p class="text-capitalize text-center"><a href="contact.php" style="color: rgb(0,0,0);">Contact Us</a></p>
                    <p class="text-capitalize text-center"><a href="faq.php" style="color: rgb(0,0,0);">FAQ'S</a></p>
                    <p class="text-capitalize text-center"><a href="survey.php" style="color: rgb(0,0,0);">Survey</a></p>
                </div>
            </div>
        </div>
