...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 21, 2019 at 02:56 AM
...
(26, 'malaysia.jpg', 'People don\'t take trips. Trips take people.', 'Malaysia', 'Kuala Lumpur', 22);
...
(6, 'Is account registration required?', 'Account registration at Nomadic Escape is required for users to access website.\r\n'),
(7, 'Can I submit my own pictures to this website?\r\n', 'YES! All of the content in the gallery has been submitted by the community. You are encouraged to contribute. All credits are published along with the resources.\r\n'),
(8, 'What are the fees for using this website?\r\n', 'Everything is free!\r\n'),
(9, 'Can post a link to my business page for free?\r\n', 'If you want to promote your company on our website, please send us an email and we will send you our rates. info@nomadicescape.com\r\n');
...
--
ALTER TABLE `blog`
  MODIFY `blog_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
