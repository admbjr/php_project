...
?>
            ...
            <div class="row">
                <div class="col-md-10 col-lg-8 mx-auto">
                    <div class="post-heading">
                        ...
                        <h2 class="text-center subheading">Please share your wonderful adventures where other members can read and share.</h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <article>
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-lg-8 mx-auto">
                    <h2 class="section-heading"><strong>Problems look mighty small from 150 miles up</strong></h2>
                    ...
                    <p>For those who have seen the Earth from space, and for the hundreds and perhaps thousands more who will, the experience most certainly changes your perspective. The things that we share in our world are far more valuable than those
                        which divide us.</p>
                    <h2 class="section-heading"><strong>Dreams</strong></h2>
